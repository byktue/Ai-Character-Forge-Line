...
def extract_features(DEEPSEEK_API_URL, DEEPSEEK_API_KEY, DEEPSEEK_MODEL, text, api_content, Part):
    ...
    for attempt in range(max_retries):
        print(f"正在向 DeepSeek API 发起提取{Part}请求 {attempt + 1} 次尝试）...")
        try:
            # 发送 POST 请求
            ...
            print(f"成功从 DeepSeek API 获取到{Part}信息。")
            return features
