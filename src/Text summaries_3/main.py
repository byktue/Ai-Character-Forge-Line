...
from appearance import appearance_sum
from name import name_sum
...
if __name__ == "__main__":
    ...
    if not (os.path.exists(PART_API_SUM) and os.path.getsize(PART_API_SUM) > 0):
        appearance_sum(PART_COMBINATION, PART_API_SUM, DEEPSEEK_API_URL, DEEPSEEK_API_KEY, DEEPSEEK_MODEL, AVATAR)
    ...
    # 检查文件是否存在且非空
    if not (os.path.exists(PART_API_SUM) and os.path.getsize(PART_API_SUM) > 0):
        events_sum(PART_COMBINATION, PART_API_SUM, DEEPSEEK_API_URL, DEEPSEEK_API_KEY, DEEPSEEK_MODEL, AVATAR)
    ...
    # 检查文件是否存在且非空
    if not (os.path.exists(PART_API_SUM) and os.path.getsize(PART_API_SUM) > 0):
        identity_sum(PART_COMBINATION, PART_API_SUM, DEEPSEEK_API_URL, DEEPSEEK_API_KEY, DEEPSEEK_MODEL, AVATAR)
    ...
    # 检查文件是否存在且非空
    if not (os.path.exists(PART_API_SUM) and os.path.getsize(PART_API_SUM) > 0):
        name_sum(PART_COMBINATION, PART_API_SUM, DEEPSEEK_API_URL, DEEPSEEK_API_KEY, DEEPSEEK_MODEL, AVATAR)
    ...
    # 检查文件是否存在且非空
    if not (os.path.exists(PART_API_SUM) and os.path.getsize(PART_API_SUM) > 0):
        personality_sum(PART_COMBINATION, PART_API_SUM, DEEPSEEK_API_URL, DEEPSEEK_API_KEY, DEEPSEEK_MODEL, AVATAR)
    ...
    # 检查文件是否存在且非空
    if not (os.path.exists(PART_API_SUM) and os.path.getsize(PART_API_SUM) > 0):
        utterance_sum(PART_COMBINATION, PART_API_SUM, DEEPSEEK_API_URL, DEEPSEEK_API_KEY, DEEPSEEK_MODEL, AVATAR)
