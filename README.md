...
## 🚀 项目概述
**Ai-Character-Forge-Line** 是一个基于AI的智能角色设定提取与模拟工具，能够从剧本杀、小说、聊天记录等文本中自动提取人物设定（如性格、口头禅、关键事件），并批量化生成精细、精准的角色文本人设。

## ✨ 项目预期实现功能
- **批量多线程处理**：高效解析长篇文本
- **精准细节提取**：结合规则引擎与DeepSeek模型
- **云端部署**：一键式Docker容器化
